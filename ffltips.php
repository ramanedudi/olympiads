...
<input type="button" value="Add Tip" class="sub" onclick="addtip()"/>

<div id="all_ffltips">
<ul id="headings" style="margin:0; padding:0;">
<li class="tiptext" style="list-style-type:none;">Fast Fat Loss Tips</li>
<li>Post Date</li>

</ul>
<ul id="alltext">
<?php
$que = mysql_query("select * from wp_webservice_ffltips order by tip_date desc");
